function Footer() {
  return (
    <>
      <footer className="bg-gray-950" id="Contacts">
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                Thank you for visiting my portfolio! I hope you enjoyed
                exploring my work as much as I enjoyed creating it. Feel free to
                reach out if you have any questions or opportunities. Looking
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              <a className="dark:text-gray-400 transition dark:hover:text-white" href="#"> FAQs </a>
            </li>

            <li>
              <a className="dark:text-gray-400 transition dark:hover:text-white" href="#"> Support </a>
            </li>
            ...
            <li>
              <a
                ...
                href="#"
              >
                <span className="dark:text-gray-400 transition dark:hover:text-white">
                  Live Chat
                </span>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    ...
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="size-5 shrink-0 dark:text-gray-400 transition dark:hover:text-white"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
